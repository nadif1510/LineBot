...
def gettotal():
	...
	apikey=AIzaSyCQwXBJ8Dx3KELnPUSR5D0pk23RIAQ9wA8
	getvalueurl='https://sheets.googleapis.com/v4/spreadsheets/1JFbvWJU1qVa8ZijU27ZlKgkobDp-meJC9makyVk1Ps8/values/sheet1!A:C?key=%s' % (apikey)
